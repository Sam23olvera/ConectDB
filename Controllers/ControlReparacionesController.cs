...
namespace ConectDB.Controllers
{
    public class ControlReparacionesController : Controller
    {
        ...
        public ActionResult Index(int cveEmp, string UfS, string xPa, string XT, int idsub)
        {
        ...
        public IActionResult PorAsig(int pagina, string usuario, string contraseña, string k, string Token, string cveEmp, string Buscar, int NumTicket, int ClaveTipoFalla, string FehTick, int idsub)
        {
            oLista.Clear();
            string desusuario = UrlEncryptor.DecryptUrl(usuario);
            string descontraseña = "";
            if (string.IsNullOrEmpty(k))
            {
                descontraseña = UrlEncryptor.DecryptUrl(contraseña);
            }
            else
            {
                descontraseña = contraseña;
                contraseña = UrlEncryptor.EncryptUrl(descontraseña);
            }
        ...
        [HttpPost]
        public IActionResult BuscarPorAsig(string usuario, string contraseña, string Token, string cveEmp, int NumTicket, int ClaveTipoFalla, DateTime FehTick, int pagina, int idsub)
        {
            oLista.Clear();
            string desusuario = UrlEncryptor.DecryptUrl(usuario);
        ...
        public IActionResult AsignacionTicket(string usuario, string contraseña, string Token, string cveEmp, string Asigna, string ticket, int pagina, int idsub)
        {
            oLista.Clear();
            string desusuario = UrlEncryptor.DecryptUrl(usuario);
            string descontraseña = UrlEncryptor.DecryptUrl(contraseña);
        ...
        public IActionResult Asignacion(int pagina, string usuario, string contraseña, string k, string Token, string cveEmp, string Buscar, int NumTicket, DateTime FehTick, int UsAsignado, int idsub)
        {
            oLista.Clear();
            string desusuario = UrlEncryptor.DecryptUrl(usuario);
            string descontraseña = "";
        ...
        public IActionResult BuscarAsignados(string usuario, string contraseña, string Token, string cveEmp, int UsAsignado, int NumTicket, DateTime FehTick, int pagina, int idsub)
        {
            oLista.Clear();
            string desusuario = UrlEncryptor.DecryptUrl(usuario);
            string descontraseña = UrlEncryptor.DecryptUrl(contraseña);
        ...
        public IActionResult AsigTiempApoyClasif(string UfS, string xPa, string XT, string cveEmp, DateTime? TiempAsig, int Apooyo_Asigna, int Clasif_Asigna, int NumTicket, int pagina, int idsub)
        {
            oLista.Clear();
        ...
        public IActionResult Repara(string usuario, string contraseña, string k, string Token, string cveEmp, int pagina, int idsub)
        {
            oLista.Clear();
            string desusuario = UrlEncryptor.DecryptUrl(usuario);
            string descontraseña = "";
        ...
        public IActionResult BuscarReparacion(string usuario, string contraseña, string Token, string cveEmp, DateTime FehTick, int TipTicket, int TipFalla, int NumTicket, int pagina, int idsub)
        {
            string desusuario = UrlEncryptor.DecryptUrl(usuario);
            string descontraseña = UrlEncryptor.DecryptUrl(contraseña);
        ...
        public IActionResult AsigRepa(string User, string Contra, string Tok, string cveEmp, string NumTicket, DateTime FechEstima,DateTime FechEstimaComparar ,string ComeMotvAsig, int idsub, int pagina)
        {
            oLista.Clear();
            string desusuario = UrlEncryptor.DecryptUrl(User);
            string descontraseña = UrlEncryptor.DecryptUrl(Contra);
        ...
        public IActionResult Fin(int pagina, string usuario, string contraseña, string k, string Token, string cveEmp, string Buscar, DateTime FehTick, int TipTicket, int TipFalla, int NumTicket, int idsub)
        {
            oLista.Clear();
            string desusuario = UrlEncryptor.DecryptUrl(usuario);
            string descontraseña = "";
        ...
        public IActionResult BuscarFinalizados(string usuario, string contraseña, string Token, string cveEmp, DateTime FehTick, int TipTicket, int TipFalla, int NumTicket, int pagina, int idsub)
        {
            oLista.Clear();
            string desusuario = UrlEncryptor.DecryptUrl(usuario);
            string descontraseña = UrlEncryptor.DecryptUrl(contraseña);
